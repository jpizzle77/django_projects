...
class Login_Reg_Manager(models.Manager):
	...
	def update_info(self,request,data):
		...
		a = Login_Reg.objects.get(id=int(b)) # gets the first record in the blogs table
...
class Message(models.Model):
	...
	user = models.ForeignKey(Login_Reg, related_name = "messages")
	object = MessageManager()

	def __repr__(self):
		return "<Decription: {} Post:{}>".format(self.description, self.post)